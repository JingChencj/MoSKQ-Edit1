...
//	public double[] m_pCoords = null;
	public double[] m_pCoords = new double[2];

	public Point(){

	}

	public Point(double[] pCoords)   //coordinate：坐标； 这里的坐标可以多于两位
	{
	...
	{
		if (m_pCoords.length != p.m_pCoords.length) throw new IllegalArgumentException();
